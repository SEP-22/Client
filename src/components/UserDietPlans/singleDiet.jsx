      ...
      >
        ...
        <div className="outerscrollable">
          <Grid item xs={12}>
            <Item>
              ...
              <IconButton
                size="small"
                color="primary"
                onClick={handleDelWindowClickOpen}
              >
                <Delete></Delete>
              </IconButton>
          ...
          <Button
            ...
            component={Link}
            to="viewPlan"
            state={{ details: props.completeDet }}
            sx={{ m: 2 }}
          >
            View
          </Button>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                Are you sure you want delete this diet plan? This action is not
                reversible. The associated shopping list will also get deleted..
              </DialogContentText>
            </DialogContent>
            <DialogActions>
              <Button onClick={handleDelWindowClose} color="secondary">
                Cancel
              </Button>
